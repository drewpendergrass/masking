...
if testing:
	...
	parser.add_argument('-par_combine', '--par_combine', type=int, default=None, help='If parallelizing, set this setting to not None to also parallelize the merge calculation along longitude. The value will be the index of longitude calculated. If you do this, use the script combine_lon_merge.py afterwards')
