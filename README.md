...
If you want to make a mask weighted by population (like area-weighted, but by population in the overlapping region), here's an example:
...
Note that if you want to use the population-weighted feature, you'll need to download the 2.5 arcminute Gridded Population of the World v4 dataset and supply a path to it.
